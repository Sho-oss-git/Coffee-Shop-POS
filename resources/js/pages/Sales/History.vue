    ...
    <AppLayout>
        <div class="space-y-6 p-3 sm:p-4">
            <div class="flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
                <div>
                    <h1 class="text-2xl font-semibold">Sales History</h1>
                ...
                <div class="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:flex-wrap sm:items-center">
                    ...
                    <button
                        ...
                        @click="clearFilters"
                        class="flex items-center gap-1 rounded-md border px-3 py-1.5 text-sm text-muted-foreground hover:bg-muted"
                    >
                        <X class="h-3.5 w-3.5" />
                        Clear
                    </button>
                    ...
                    <tbody>
                        <template v-for="t in transactions.data" :key="t.id">
                            ...
                            >
                                ...
                                <td class="p-2 text-right">{{ formatCurrency(t.amount_received) }}</td>
                                <td class="p-2 text-right">{{ formatCurrency(t.change) }}</td>
                                <td class="p-2">
                                    <span
                                ...
                                <td colspan="11" class="p-0">
                                    <div class="flex flex-col gap-4 p-4 lg:flex-row">
                                        ...
                                        <div class="flex-1">
                                            <table class="w-full text-xs">
                                                ...
                                                <tbody>
                                                    <tr v-for="item in t.items" :key="item.id" class="border-t border-border/60">
                                                        ...
                                                        <td class="p-1.5 text-right">
                                                            {{ item.cogs !== null ? formatCurrency(item.cogs) : '—' }}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <!-- Order details -->
                                            <div v-if="t.order_number || t.customer_name || t.notes" class="mt-3 flex flex-wrap gap-x-6 gap-y-1 text-xs text-muted-foreground">
                                        ...
                                        <div v-if="t.payment_method === 'gcash'" class="w-full shrink-0 lg:w-64">
                                            <div class="rounded-lg border p-3">
                                                ...
                                                <p class="mt-1 text-xs">
                                                    Amount Paid: <span class="font-medium">{{ formatCurrency(t.amount_received) }}</span>
                                                </p>
                        ...
                        <tr v-if="!transactions.data.length">
                            <td colspan="11" class="p-6 text-center text-muted-foreground">
